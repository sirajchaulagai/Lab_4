...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mReply = findViewById(R.id.text_header);
        ...
        if (message.equals("text_one")) {
            mReply.setText(R.string.article1);
        } else if (message.equals("text_two")) {
            mReply.setText(R.string.article2);
        } else if (message.equals("text_three")) {
            mReply.setText(R.string.article3);
        }
    }
}
